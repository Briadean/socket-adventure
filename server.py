...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return [
            "You are in a room with a wildflower meadow. A small deer nudges your hand looking to be pet.",
            "You are in a room with ankle deep water, that has a 'Beware Piranha' sign on the wall.",
            "You are in a room with brutal winds. You loose an article of clothing.",
            "You are in a pitch black room filled with stars. A telescope stands in front of you."][room_number]
